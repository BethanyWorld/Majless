<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#editContent").click(function (event) {
            toggleLoader();
            $inputContentId = $.trim($("#inputContentId").val());
        ...
        $("#rejectContent").click(function (event) {
            toggleLoader();
            $inputContentId = $.trim($("#inputContentId").val());
            $sendData = {
                'inputContentId': $inputContentId
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'Content/doRejectContent',
                data: $sendData,
                success: function (data) {
                    toggleLoader();
                    $result = jQuery.parseJSON(data);
        ...
        $("#acceptContent").click(function (event) {
            toggleLoader();
            $inputContentId = $.trim($("#inputContentId").val());
            $sendData = {
                'inputContentId': $inputContentId
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'Content/doAcceptContent',
                data: $sendData,
                success: function (data) {
                    toggleLoader();
                    $result = jQuery.parseJSON(data);
