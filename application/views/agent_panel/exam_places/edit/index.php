                ...
                <div class="row col-xs-12 card">
                    ...
                    <div class="body">
                        <div class="col-xs-12">
                            <div class="col-xs-12 col-sm-4" id="step1">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="hidden"
                                                   name="inputExamPlaceId"
                                                   id="inputExamPlaceId"
                                                   value="<?php echo $examPlace['ExamPlaceId']; ?>"
                                                   />
                                            <input
                                                    value="<?php echo $examPlace['ExamPlaceTitle']; ?>"
                                                    type="text"
                                                   class="form-control"
                            ...
                            <div class="col-xs-12 col-sm-4" id="step3">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number"
                                                   value="<?php echo $examPlace['ExamPlaceDefaultCapacity']; ?>"
                                                   min="1"
                                                   value="1"
                                                   class="form-control"
                            ...
                            <div class="col-xs-12" id="step4">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input
                                                    value="<?php echo $examPlace['ExamPlaceAddress']; ?>"
                                                    type="text"
                                                   class="form-control"
                            ...
                            <div class="col-xs-12">
                                <button type="button" id="editExamPlace" class="btn btn-primary waves-effect">ذخیره</button>
                            </div>
                        </div>
                    </div>
                </div>
