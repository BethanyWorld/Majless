...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on('click', '.accept-exam', function () {
            ...
            $.confirm({
                title: '',
                content: 'آیا از تایید آزمون مرحله اول '+ $title +' مطمئن هستید؟',
                buttons: {
                    specialKey: {
                        text: 'تایید',
                        btnClass: 'btn-blue',
                        action: function () {
                            ...
                            $.ajax({
                                type: 'post',
                                url: base_url + 'Exams/doAcceptRequest',
                                data: $sendData,
        ...
        $(document).on('click', '.reject-exam', function () {
            ...
            $.confirm({
                title: '',
                content: 'آیا از رد آزمون مرحله اول '+ $title +' مطمئن هستید؟',
                buttons: {
                    specialKey: {
                        text: 'تایید',
                        btnClass: 'btn-blue',
                        action: function () {
                            ...
                            $.ajax({
                                type: 'post',
                                url: base_url + 'Exams/doRejectRequest',
                                data: $sendData,
                                success: function (data) {
                                    toggleLoader();
                                    $result = jQuery.parseJSON(data);
