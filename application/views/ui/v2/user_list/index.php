        ...
        <div class="row">
            <div class="col-md-6">
                <div class="breadcrumb-area">
                    <h1>فهرست کارجو ها</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">صفحه اصلی</a></li>
                            <li class="breadcrumb-item active" aria-current="page">فهرست کارجو ها</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col">
                <div class="job-listing-container">
                    <div class="filtered-job-listing-wrapper">
                        ...
                        <div class="job-filter-result" id="userContainer">
                        </div>
                    ...
                    <div class="job-filter-wrapper">
                        ...
                        <div class="job-filter-dropdown same-pad category">
                            <div class="dropdown bootstrap-select">
                                <select id="inputMainMajorId" class="selectpicker" data-live-search="true">
                                    <option value="" selected>رشته تحصیلی</option>
                                    <?php foreach ($majors as $item) { ?>
                                        <option value="<?php echo $item['MajorId']; ?>">
                                            <?php echo $item['MajorTitle']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div data-id="job-type" class="job-filter job-type same-pad d-none">
                        ...
                        <div data-id="experience" class="job-filter experience same-pad d-none">
