                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 padding-0">
                                        <ul class="list-group ul-background-color-hr">
                                            <li class="list-group-item extra-padding-top-25 odd-background-color-div">
                                                <div class="list-group-Grade col-md-12 col-xs-12 padding-0">
                                                 ...
                                                 <b class="text-danger">*</b>
                                                        ...
                                                        <label class="GradeNotify" id="GradeNotify">
                                                            حداقل مقطع تحصیلی مورد نیاز برای نامزدی انتخابات , کارشناسی ارشد یا
                                                            معادل آن می باشد
                                                        </label>
                                                    </div>
                                                 ...
                                                 <b class="text-danger">*</b>
                                                        ...
                                                        <select class="form-control form-control-lg"
                                                                ...
                                                                id="inputCandidateUniversityLevelType">
                                                            <option></option>
                                                            <option value="PayamNooruniversityLevelType">پیام نور</option>
                                                            <option value="SeminaryLevelType">حوزه علمیه</option>
                                                            <option value="AbroadLevelType">خارج از کشور</option>
                                                            <option value="AzadUniversityLevelType">دانشگاه آزاد</option>
                                                            <option value="GovernmentdailyLevelType">دولتی-روزانه</option>
                                                            <option value="GovernmentnightLevelType">دولتی-شبانه</option>
                                                            <option value="VirtualgovernmentLevelType">دولتی-مجازی</option>
                                                            <option value="GovernmentCampus">دولتی-پردیس خودگردان</option>
                                                            <option value="AppliedScienceLevelType">علمی کاربردی</option>
                                                 ...
                                                 <b class="text-danger">*</b>
                                                        ...
                                                        <select class="form-control form-control-lg"
                                                            ...
                                                            <option value="AbroadLevelType">راضی </option>
                                                            <option value="AzadUniversityLevelType">فنی</option>
                                                            <option value="GovernmentdailyLevelType">معارف اسلامی</option>
                                                    ...
                                                    <div class="col-md-4 col-xs-12 form-group RightFloat CandidateUniversityName">
                                                        ...
                                                        <input id="inputCandidateUniversityName" type="text"
                                                               name="inputCandidateUniversityName"
