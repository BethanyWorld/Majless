...
<ul class="list-group" style="padding: 0;">
    ...
    <li class="list-group-item"><a style="direction: rtl;text-align: right;display: inline-block;font-size: 14px;" href="<?php echo base_url('Profile/uploadDocuments') ?>">بارگذاری مدارک تایید صلاحیت شورای نگهبان</a></li>
    <li class="list-group-item"><a style="direction: rtl;text-align: right;display: inline-block;font-size: 14px;" href="<?php echo base_url('Profile/uploadCommitmentDocuments') ?>">بارگذاری تعهدنامه</a></li>
