...
<head>
    ...
    <link rel='stylesheet' id='campaign_options-css' href='<?= $_DIR; ?>css/options.css?ver=1.<?php echo rand(); ?>' type='text/css' media='all'/>
    <link rel='stylesheet' id='campaign_style-css' href='<?= $_DIR; ?>css/theme.css?ver=1.<?php echo rand(); ?>' type='text/css' media='all'/>
