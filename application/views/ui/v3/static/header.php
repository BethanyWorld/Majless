...
<head>
    ...
    <link rel='stylesheet' id='bootstrap-css' href='<?= $_DIR; ?>css/bootstrap.min.css?ver=3.3.7' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='fontawesome-css' href='<?= $_DIR; ?>css/font-awesome-css.min.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='bootstrap-theme-css' href='<?= $_DIR; ?>css/bootstrap-theme.min.css?ver=3.3.7'
          type='text/css' media='all'/>
    <link rel='stylesheet' id='mmenu-css' href='<?= $_DIR; ?>css/jquery.mmenu.all.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='animate-css-css' href='<?= $_DIR; ?>css/animate.min.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='campaign_options-css' href='<?= $_DIR; ?>css/options.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='campaign_style-css' href='<?= $_DIR; ?>css/theme.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='slick-css' href='<?= $_DIR; ?>css/slick.css?ver=1.0' type='text/css' media='all'/>
    <link rel='stylesheet' id='slick-theme-css' href='<?= $_DIR; ?>css/slick-theme.css?ver=1.0' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='slick-theme-css' href='<?= $_DIR; ?>css/lightbox.min.css?ver=1.0' type='text/css'
          media='all'/>
    ...
    <script type="text/javascript">
        ...
        function is_valid_length_phone($string, $length) {
            debugger;
            if ($string.length === $length) {
                return true;
            }
        ...
        //     $balckList =['<','>','#','=','+','-','*','/'];
        //     $balckList.each(function(data) {
        //         $string.replaceWith(data);
        //     });
        //     return $string;
        // }
        function isText(value) {
            $ckeckedtext = /[A-Za-z]/.test(value);
            $ckeckedtextpersion = /[\u0600-\u06FF\s]/.test(value);
            $ckeckedNum = /\d/.test(value);
            if ((!$ckeckedNum) && ($ckeckedtext || $ckeckedtextpersion)) {
                return true;
            }
        }

        function isValueInteger(value) {
            $ckeckedNummm = Math.floor(value) == value && $.isNumeric(value);
            if ($ckeckedNummm && value > 0) {
                return true;
            }
        }

        function isCaptcha($string) {
            debugger;
            if ($string.length === 5) {
                return true;
            }
        ...
        function isContactContent(value) {
            debugger;
            if (value.length <= 512) {
                return true;
            }
