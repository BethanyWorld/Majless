...
class ReportAbuse extends CI_Controller{
    ...
    public function index(){
        ...
        $this->load->view('admin_panel/report_abuse/home/index');
        $this->load->view('admin_panel/report_abuse/home/index_css');
        $this->load->view('admin_panel/report_abuse/home/index_js');
        $this->load->view('admin_panel/static/footer');
    }
    public function doPagination(){
        $inputs = $this->input->post(NULL, TRUE);
        $data = $this->ModelReportAbuse->getReportAbuses($inputs);
        $data['htmlResult'] = $this->load->view('admin_panel/report_abuse/home/pagination', $data, TRUE);
        unset($data['data']);
    ...
    public function detail($reportId){
        ...
        $this->load->view('admin_panel/static/header', $data);
        $this->load->view('admin_panel/report_abuse/detail/index' , $data);
        $this->load->view('admin_panel/report_abuse/detail/index_css');
        $this->load->view('admin_panel/report_abuse/detail/index_js');
        $this->load->view('admin_panel/static/footer');
    }
