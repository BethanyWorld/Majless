...
class ExamPlaces extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('agent_panel/exam_places/home/index', $data);
        $this->load->view('agent_panel/exam_places/home/index_css');
        $this->load->view('agent_panel/exam_places/home/index_js');
        $this->load->view('agent_panel/static/footer');
    }
    public function doPagination()
    {
        $inputs = $this->input->post(NULL, TRUE);
        $data = $this->ModelExam->getExamPlaceByAgentId($inputs);
        $data['htmlResult'] = $this->load->view('agent_panel/exam_places/home/pagination', $data, TRUE);
        unset($data['data']);
    ...
    public function add(){
        ...
        $this->load->view('agent_panel/static/header', $data);
        $this->load->view('agent_panel/exam_places/add/index', $data);
        $this->load->view('agent_panel/exam_places/add/index_css');
        $this->load->view('agent_panel/exam_places/add/index_js');
        $this->load->view('agent_panel/static/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('agent_panel/static/header', $data);
        $this->load->view('agent_panel/exam_places/edit/index', $data);
        $this->load->view('agent_panel/exam_places/edit/index_css');
        $this->load->view('agent_panel/exam_places/edit/index_js');
        $this->load->view('agent_panel/static/footer');
    }
