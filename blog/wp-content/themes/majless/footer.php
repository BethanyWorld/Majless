...
<footer id="footer-promo">
    <div class="container">
        ...
        <a target="_blank" href="https://www.aparat.com/azmaa_net" class="tbWow fadeIn footer-icon-svg"
           data-wow-delay="0.3s">
...
<script type='text/javascript' src='<?= $_DIR; ?>assets/js/bootstrap.min.js?ver=3.3.7'></script>
<script type='text/javascript' src='<?= $_DIR; ?>assets/js/loading_screen.js?ver=1.1'></script>
<script type='text/javascript' src='<?= $_DIR; ?>assets/js/theme.js?ver=1.1'></script>
</body>
</html>