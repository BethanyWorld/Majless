...
!function (e, t) {
    ...
    !function (z) {
        ...
        function P(e, t, i) {
            ...
            for (var n = Object.keys(t), s = 0, o = e.length; s < o; s++) for (var r = e[s].querySelectorAll("*"), l = 0, a = r.length; l < a; l++) {
                var c = r[l], d = c.nodeName.toLowerCase();
                if (-1 !== n.indexOf(d)) for (var h = [].slice.call(c.attributes), p = [].concat(t["*"] || [], t[d] || []), u = 0, f = h.length; u < f; u++) {
                    var m = h[u];
        ...
        if (n.classList.add("c1", "c2"), !n.classList.contains("c2")) {
            var s = DOMTokenList.prototype.add, o = DOMTokenList.prototype.remove;
        ...
        function S(e) {
            var t, i = [], n = e.selectedOptions;
            if (e.multiple) for (var s = 0, o = n.length; s < o; s++) t = n[s], i.push(t.value || t.text); else i = e.value;
            return i
        }
        ...
        var x, I, k, y, C, U = (x = {
            ...
            104: "8",
            105: "9"
        }, T = 27, A = 13, H = 32, D = 9, N = 38, R = 40, W = {success: !1, major: "3"};
        try {
        ...
        var _ = new RegExp(N + "|" + R), q = new RegExp("^" + D + "$|" + T), G = function (e, t, i) {
            ...
            if (!0 === t) for (; 0 < s.childNodes.length;) F.fragment.appendChild(s.childNodes[0]); else F.fragment.appendChild(s);
            return F.fragment
        }, Z = function (e) {
        ...
        J.VERSION = "1.13.7", J.BootstrapVersion = W.major, J.DEFAULTS = {
            ...
            countSelectedText: function (e, t) {
                return 1 == e ? "{0} item selected" : "{0} مورد انتخاب شده است"
            },
            ...
            createDropdown: function () {
                var e, t = this.multiple || this.options.showTick ? " show-tick" : "",
                    i = this.autofocus ? " autofocus" : "", n = "", s = "", o = "", r = "";
            ...
            createView: function (T, e) {
                ...
                function i(e, t) {
                    var i, n, s, o, r, l, a, c, d, h, p = A.selectpicker.current.elements.length, u = [], f = !0,
                        m = A.isVirtual();
            ...
            createLi: function () {
                var e, t, i = this, n = i.options.iconBase, s = ':not([hidden]):not([data-hidden="true"])', o = [],
                    r = 0, l = [], a = 0, c = 0, d = -1;
                ...
                for (var h = this.$element[0].options, p = 0, u = h.length; p < u; p++) {
                    ...
                    if (d++, !f.classList.contains("bs-title-option")) {
                        var m, v, g, b, w = {
                            ...
                            }, x = f.className || "", I = f.style.cssText, k = I ? U(I) : "", $ = w.content,
                            y = f.textContent, S = f.parentNode, E = f.nextElementSibling, C = f.previousElementSibling,
                            O = "OPTGROUP" === S.tagName, z = O && S.disabled, L = f.disabled || z,
                            T = C && "OPTGROUP" === C.tagName, A = {hidden: "true" === S.getAttribute("data-hidden")};
                        if (!0 === w.hidden || f.hidden || O && (!0 === A.hidden || S.hidden) || i.options.hideDisabled && (L || z)) m = f.prevHiddenIndex, E && (E.prevHiddenIndex = void 0 !== m ? m : p), d--; else {
                            if (E && void 0 !== E.prevHiddenIndex && (E.prevHiddenIndex = void 0), O && !0 !== w.divider) {
                                var H = " " + S.className || "", D = f.previousElementSibling;
                                if (void 0 !== (m = f.prevHiddenIndex) && (D = h[m].previousElementSibling), !D) {
                                    ...
                                    var N = S.label, P = U(N), R = A.subtext, W = A.icon;
                                ...
                                if (i.options.hideDisabled) if (T) C.querySelectorAll("option:disabled").length === C.children.length && (T = !1); else if (void 0 !== (m = f.prevHiddenIndex)) if ((b = h[m].previousElementSibling) && "OPTGROUP" === b.tagName && !b.disabled) b.querySelectorAll("option:disabled").length < b.children.length && (T = !0);
            ...
            render: function () {
                this.setPlaceholder();
                var e, t, i = this, n = this.$element[0].selectedOptions, s = n.length, o = this.$button[0],
                    r = o.querySelector(".filter-option-inner-inner"),
                    l = document.createTextNode(this.options.multipleSeparator), a = F.fragment.cloneNode(!1), c = !1;
                if (this.togglePlaceholder(), this.tabIndex(), "static" === this.options.selectedTextFormat) a = Y({text: this.options.title}, !0); else if ((e = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && 1 < s) && (e = 1 < (t = this.options.selectedTextFormat.split(">")).length && s > t[1] || 1 === t.length && 2 <= s), !1 === e) {
                    ...
                    a = Y({text: v.replace("{0}", s.toString()).replace("{1}", m.toString())}, !0)
                }
            ...
            setStyle: function (e, t) {
                var i, n = this.$button[0], s = this.options.style.split(" ");
                this.$element.attr("class") && this.$newElement.addClass(this.$element.attr("class").replace(/selectpicker|mobile-device|bs-select-hidden|validate\[.*\]/gi, "")), W.major < 4 && this.$newElement[0].classList.add("bs3"), i = e ? e.split(" ") : s, "add" == t ? n.classList.add.apply(n.classList, i) : "remove" == t ? n.classList.remove.apply(n.classList, i) : (n.classList.remove.apply(n.classList, s), n.classList.add.apply(n.classList, i))
            },
            liHeight: function (e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    this.sizeInfo || (this.sizeInfo = {});
                    var t = document.createElement("div"), i = document.createElement("div"),
                        n = document.createElement("div"), s = document.createElement("ul"),
                    ...
                    var v, g = a.offsetHeight, b = r ? r.offsetHeight : 0, w = d ? d.offsetHeight : 0,
            ...
            getSelectPosition: function () {
                var e, t = z(window), i = this.$newElement.offset(), n = z(this.options.container);
            ...
            setMenuSize: function (e) {
                ...
                var t, i, n, s, o, r, l, a = this.sizeInfo.selectWidth, c = this.sizeInfo.liHeight,
            ...
            selectPosition: function () {
                ...
                var n, s, o, r = this, l = z(this.options.container), e = function (e) {
                    var t = {},
            ...
            setOptionStatus: function () {
                var e = this, t = this.$element[0].options;
                if (e.noScroll = !1, e.selectpicker.view.visibleElements && e.selectpicker.view.visibleElements.length) for (var i = 0; i < e.selectpicker.view.visibleElements.length; i++) {
                    ...
                    if (s) {
                        var o = this.selectpicker.main.map.newIndex[n], r = this.selectpicker.main.elements[o];
            ...
            clickListener: function () {
                ...
                t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
                    ...
                    var i = z(this), n = y.isVirtual() ? y.selectpicker.view.position0 : 0,
                        s = y.selectpicker.current.map.originalIndex[i.parent().index() + n], o = S(y.$element[0]),
                        r = y.$element.prop("selectedIndex"), l = !0;
                    if (y.multiple && 1 !== y.options.maxOptions && e.stopPropagation(), e.preventDefault(), !y.isDisabled() && !i.parent().hasClass(j.DISABLED)) {
                        var a = y.$element.find("option"), c = a.eq(s), d = c.prop("selected"),
                            h = c.parent("optgroup"), p = h.find("option"), u = y.options.maxOptions,
                            ...
                            if (c.prop("selected", !d), y.setSelected(s, !d), i.trigger("blur"), !1 !== u || !1 !== f) {
                                ...
                                if (u && m || f && v) if (u && 1 == u) {
                                    ...
                                    var w = "string" == typeof y.options.maxOptionsText ? [y.options.maxOptionsText, y.options.maxOptionsText] : y.options.maxOptionsText,
                                        ...
                                        k = x[1].replace("{n}", f), $ = z('<div class="notify"></div>');
            ...
            liveSearchListener: function () {
                ...
                this.$button.on("click.bs.dropdown.data-api", function () {
                    ...
                    if (u.selectpicker.search.map.newIndex = {}, u.selectpicker.search.map.originalIndex = {}, u.selectpicker.search.elements = [], u.selectpicker.search.data = [], e) {
                        var t = [], i = e.toUpperCase(), n = {}, s = [], o = u._searchStyle(),
            ...
            changeAll: function (e) {
                if (this.multiple) {
                    void 0 === e && (e = !0);
                    var t = this.$element[0], i = t.options, n = 0, s = 0, o = S(t);
            ...
            keydown: function (e) {
                var t, i, n, s, o, r = z(this), l = r.hasClass("dropdown-toggle"),
                    a = (l ? r.closest(".dropdown") : r.closest(V.MENU)).data("this"), c = a.findLis(), d = !1,
                    h = e.which === D && !l && !a.options.selectOnTab, p = _.test(e.which) || h,
